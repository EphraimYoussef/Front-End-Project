    ...
    <>
      <div className="flex  h-36 w-full bg-rose-600 justify-between items-center px-36 max-md:px-10 max-md:py-6 max-md:flex-col max-lg:px-10">
        ...
        <div className='flex shrink'>
            ...
            <button type="submit" className="text-white text-lg w-32 h-12 bg-black hover:bg-slate-800 ease-in-out duration-300 max-xl:w-24">Subscribe</button>
        </div>
      </div>
        ...
        <div className="mx-36 max-w-screen-xl space-y-8 py-16 max-lg:mx-5">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4 max-md:gap-12">
              <div>
                <p className="font-medium text-gray-200 dark:text-white">Useful Links</p>
              ...
              <div>
                <p className="font-medium text-gray-200 dark:text-white">Category</p>
              ...
              <div>
                <p className="font-medium text-gray-200 dark:text-white">My Account</p>
              ...
              <div>
                <p className="font-medium text-gray-200 dark:text-white">Contact Info</p>

                <ul className="mt-6 space-y-4 text-sm">
                  <li>
                    <a href="#" className="text-gray-400 transition hover:opacity-75 dark:text-gray-200 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-geo-alt" viewBox="0 0 16 16">
                      <path d="M12.166 8.94c-.524 1.062-1.234 2.12-1.96 3.07A32 32 0 0 1 8 14.58a32 32 0 0 1-2.206-2.57c-.726-.95-1.436-2.008-1.96-3.07C3.304 7.867 3 6.862 3 6a5 5 0 0 1 10 0c0 .862-.305 1.867-.834 2.94M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10"/>
                      <path d="M8 8a2 2 0 1 1 0-4 2 2 0 0 1 0 4m0 1a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
                    </svg>  5 Ahmed Zewail , Cairo.
                    </a>
                  </li>
