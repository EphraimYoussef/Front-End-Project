        ...
        <div className="mx-36 max-w-screen-xl space-y-8 py-16 max-lg:mx-5">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4 max-md:gap-12">
              ...
              <div>
                <p className="font-medium text-gray-900 dark:text-white">My Account</p>
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  <li>
                    <a href="#" className="text-gray-700 transition hover:opacity-75 dark:text-gray-200 flex items-center gap-2">
